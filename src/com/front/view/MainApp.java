...
public abstract class MainApp {
	...
	public static void main(String[] args) {
		...
		c.createFlowerShop("Navarro");							//store creation
		c.getAllFlowerShops().forEach(System.out::println);		//show stock: zeroed for now 
		...
		c.getAllFlowerShops().forEach(System.out::println);		//show stock: fully now 
